...
* **[`app/services/retail_seed_data.py`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/services/retail_seed_data.py):** High-fidelity supermarket simulation dataset generator (50m x 30m store blueprint, 25 Dahua camera streams with calibrated homography matrices, 500+ customer tracks, 200+ POS transactions, pre-computed analytics).
* **[`tests/test_retail_engine.py`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/tests/test_retail_engine.py):** Comprehensive 18-test suite validating retail funnel math, homography projections, journey stitching, queue analytics, zero-PII privacy, decision engine anomalies, and 25-camera seed dataset integrity.
* **[`app/routes/cameras.py`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/routes/cameras.py):** 28-channel supermarket camera matrix feeds, snapshot rendering, `/api/v1/cameras/scan`, and feature toggle endpoints.
* **[`app/routes/analytics.py`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/routes/analytics.py):** Retail intelligence analytics endpoints for store KPIs, interactive floorplan data, conversion funnels, checkout queue metrics, AI action center recommendations, and executive daily digest.
* **[`app/routes/zones.py`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/routes/zones.py):** REST endpoints for adding, listing, and deleting tripwires, intrusion polygons, and exclusion masks.
* **[`app/routes/system.py`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/routes/system.py):** Hardware profiling and real-time CPU/GPU/RAM telemetry.

### Web Studio & Dashboard (`edge_backend/app/static/`)
* **[`app/static/index.html`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/static/index.html):** Multi-Tab Master Cyber-Glassmorphism Dashboard with Live Camera Matrix, 2D Store Blueprint HUD, Retail Analytics & Funnels, AI Action Center, and Executive Daily Digest.
* **[`app/static/analytics.html`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/static/analytics.html):** Dedicated Standalone Retail Intelligence Hub.
* **[`app/static/studio.html`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/static/studio.html):** Interactive Canvas Studio sub-page with Tripwires, Restricted Intrusion Polygons, Privacy Masks, live telemetry, and back button.
* **[`app/static/js/floorplan.js`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/static/js/floorplan.js):** HTML5 Canvas & Layered SVG store blueprint HUD engine with Gaussian heatmap interpolation, animated shoppers, flow vectors, and clickable zone inspector.
* **[`app/static/js/analytics.js`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/static/js/analytics.js):** Dashboard controller for live polling, Chart.js graphs, 28-camera matrix filtering, FPS decimation, AI action center mutations, and print digest export.
* **[`app/static/js/studio.js`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/edge_backend/app/static/js/studio.js):** Interactive canvas drawing and zone REST client.
...
* **[`docs/supermarket_cctv/supermarket_cctv_deployment_spec.md`](file:///home/meoclavezz/Projects-1/Edge_AI_CCTV/docs/supermarket_cctv/supermarket_cctv_deployment_spec.md):** Complete hardware, network, port mapping (UPnP), and Dahua P2P cloud specification for the Pearcedale Supermarket CCTV System (Australia) including RTSP streaming endpoints and go2rtc integration.
