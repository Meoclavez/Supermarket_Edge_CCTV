...
def generate_25_camera_definitions() -> List[Dict[str, Any]]:
    ...
    for idx, (cam_id, name, zone_id, center, bounds) in enumerate(camera_metadata, start=1):
        ...
        camera_dict = {
            ...
            "rtsp_url": f"rtsp://admin:<NVR_PASSWORD_REDACTED>@192.168.20.160:554/cam/realmonitor?channel={idx}&subtype=1",
            "rtsp_main_url": f"rtsp://admin:<NVR_PASSWORD_REDACTED>@192.168.20.160:554/cam/realmonitor?channel={idx}&subtype=0",
